...
export const metadata: Metadata = { title: 'Projects — Sai Ruthvik Munugoti' }
  ...
  return (
    <section className="mx-auto max-w-[760px] px-7 py-14">
      ...
      <p className="mt-9 text-[14.5px] text-muted">
        Smaller experiments — a from-scratch BPE tokenizer, neural style transfer, Pegasus-based
        summarization, recommendation and forecasting models — live on{' '}
        <a
